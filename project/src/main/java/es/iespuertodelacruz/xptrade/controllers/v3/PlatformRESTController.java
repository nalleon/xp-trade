...
public class PlatformRESTController {
    ...
    public ResponseEntity<?> getById(@PathVariable Integer id) {
        ...
        if (aux != null){
            ...
            ApiResponse<PlatformDTO> response =
                    new ApiResponse<>(302, "Platform found", dto);
            return ResponseEntity.status(HttpStatus.FOUND).body(response);
        }

        ApiResponse<PlatformDTO> errorResponse = new ApiResponse<>(404, "Platform NOT found", null);
    ...
    public ResponseEntity<?> getByName(@PathVariable String name) {
        ...
        if (aux != null){
            ...
            ApiResponse<PlatformDTO> response =
                    new ApiResponse<>(202, "Platform found", dto);
            return ResponseEntity.status(HttpStatus.FOUND).body(response);
        }
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<?>> create(PlatformDTO dto) {
        if (dto == null) {
