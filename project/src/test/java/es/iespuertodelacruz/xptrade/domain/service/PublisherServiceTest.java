...
public class PublisherServiceTest extends TestUtilities {
    @Mock
    IGenericRepository<Publisher, Integer, String> repositoryMock;
    ...
    void getAllTest() {
        ...
        list.add(new Publisher("Admin"));
        list.add(new Publisher("User"));
        list.add(new Publisher("Guest"));
    ...
    @Test
    void getOneTest() {
        Mockito.when(repositoryMock.findById(1)).thenReturn(new Publisher());
    ...
    @Test
    void getByNameTest() {
        Mockito.when(repositoryMock.findByName(NAME)).thenReturn(new Publisher());
        Assertions.assertNotNull(service.findByName(NAME), MESSAGE_ERROR);
    }

    @Test
    void addTest() {
        Mockito.when(repositoryMock.save(Mockito.any(Publisher.class))).thenReturn(new Publisher());
