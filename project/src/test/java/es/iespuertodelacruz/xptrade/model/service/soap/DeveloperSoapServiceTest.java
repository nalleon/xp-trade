...
public class DeveloperSoapServiceTest extends TestUtilities {
    @Mock
    IDeveloperEntityRepository repositoryMock;

    @Mock
    DeveloperEntityService serviceMock;

    @InjectMocks
    DeveloperSoapService service;

    @BeforeEach
    public void beforeEach (){
        MockitoAnnotations.openMocks(this);
        serviceMock = new DeveloperEntityService();
        serviceMock.setRepository(repositoryMock);
        service = new DeveloperSoapService();
