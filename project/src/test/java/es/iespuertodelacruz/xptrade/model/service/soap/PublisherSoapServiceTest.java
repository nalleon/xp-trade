...
public class PublisherSoapServiceTest extends TestUtilities {
    @Mock
    IPublisherEntityRepository repositoryMock;

    @Mock
    PublisherEntityService serviceMock;

    @InjectMocks
    PublisherSoapService service;

    @BeforeEach
    public void beforeEach (){
        MockitoAnnotations.openMocks(this);
        serviceMock = new PublisherEntityService();
        serviceMock.setRepository(repositoryMock);
        service = new PublisherSoapService();
