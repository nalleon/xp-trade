...
public class RegionSoapServiceTest extends TestUtilities {
    @Mock
    IRegionEntityRepository repositoryMock;

    @InjectMocks
    RegionEntityService serviceMock;


    @Mock
    RegionSoapService service;


    @BeforeEach
    public void beforeEach (){
        MockitoAnnotations.openMocks(this);
        service = new RegionSoapService();
        serviceMock = new RegionEntityService();
