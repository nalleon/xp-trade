...
public class TagEntityTest extends TestUtilities {
    TagEntity item;

    @BeforeEach
    public void beforeEach(){
        item = new TagEntity();
        item = new TagEntity(NAME);
    ...
    public void equalsTest(){
        TagEntity equals = new TagEntity(ID);
        TagEntity differentId = new TagEntity(2);
        String str = "str";
        TagEntity nullObject = null;
