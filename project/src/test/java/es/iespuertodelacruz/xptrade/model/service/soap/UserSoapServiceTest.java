...
public class UserSoapServiceTest extends TestUtilities {
    @Mock
    ...
    public void beforeEach (){
        ...
        service = new UserSoapService();
        serviceRestMock = new UserEntityService();
        serviceRestMock.setRepository(repositoryMock);
        serviceRestMock.setRoleRepository(repositoryRoleMock);
        service.setService(serviceRestMock);
    }
    @Test
    void getAllTest() {
    ...
    void addTest() {
        ...
        when(serviceRestMock.getRoleUser()).thenReturn(new RoleEntity());
